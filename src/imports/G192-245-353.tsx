import svgPaths from "./svg-pdfqt3g8jh";
  ...
  return (
    <div className="absolute contents inset-0" data-name="g200">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 731.407 268.021">
        <g id="g202">
          <path d={svgPaths.p34c92080} fill="url(#paint0_linear_245_419)" id="path226" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_245_419" x1="-0.0005925" x2="731.407" y1="134.011" y2="134.011">
