    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-[#D4AF37] to-[#B8941F] rounded-full mb-6 active:scale-110 md:hover:scale-110 transition-transform duration-300 cursor-pointer animate-pulse">
          ...
          <Button
            ...
            className="bg-gradient-to-br from-[#D4AF37] to-[#B8941F] active:opacity-90 md:hover:opacity-90 text-white px-6 md:px-8 py-5 md:py-6 touch-manipulation active:scale-95 md:hover:scale-105 md:hover:shadow-xl transition-all duration-300"
          >
