...
export function MenuPage() {
  ...
  const renderMenuItems = () => {
    ...
    const items =
      (currentMenuData as any)[selectedCategoryKey] as MenuItem[] || [];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-64 md:h-80">
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1680990999782-ba7fe26e4d0b"
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center">
            <h1 className="text-white mb-2 font-logo font-light">
              {t("menu.title")}
            </h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
        {/* Categories – 2 rows horizontal scroll on mobile */}
          ...
          >
            {categoryKeys.map((key, index) => (
              <button
                ...
                className={`px-5 py-2.5 rounded-full whitespace-nowrap transition-all duration-300 active:scale-95 ${
