...
import heroImage from "figma:asset/37c2d0fe4b665f820df854fc0346df8e026678bd.png";
...
export function HomePage({ onNavigate, onReserve }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen bg-black">
      {/* Hero Section */}
      <div className="relative overflow-hidden w-full bg-black" style={{ 
        height: '100vh',
        minHeight: '100vh'
      }}>
        {isMobile ? (
          <img
            ...
            style={{ 
              ...
              filter: 'saturate(1.4) contrast(1.08) brightness(1.15)',
              position: 'absolute',
              top: 0,
              left: 0,
              right: 0,
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/10 to-black/50" style={{
          position: 'absolute',
          top: 0,
          left: 0,
          right: 0,
        ...
        <div className="relative z-10 flex flex-col items-center justify-end h-full text-center px-5 pb-32" style={{
          paddingTop: 'env(safe-area-inset-top, 20px)'
        }}>
          {/* Pure Summer Tagline */}
          <div className={`mb-6 w-full max-w-[280px] transition-all duration-700 delay-200 ${
          ...
          <div className={`flex flex-col gap-4 w-full max-w-sm transition-all duration-700 delay-300 ${
            isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}>
            <Button 
              onClick={() => onNavigate('menu')}
              className="w-full bg-gradient-to-br from-[#D4AF37] via-[#C9A961] to-[#B8941F] active:from-[#E5C158] active:via-[#D4AF37] active:to-[#C9A961] text-white shadow-lg shadow-[#D4AF37]/40 px-8 py-4 touch-manipulation active:scale-95 transition-all duration-300 text-base"
            >
              {t('hero.menu')}
            </Button>
            <Button 
              onClick={onReserve}
              variant="outline"
              className="w-full border-2 border-white bg-white/10 backdrop-blur-sm text-white active:bg-white active:text-gray-900 px-8 py-4 touch-manipulation active:scale-95 transition-all duration-300 flex items-center justify-center gap-2 text-base"
            >
      ...
      <div ref={aboutRef} className="bg-white py-20 px-5">
        <div className="max-w-4xl mx-auto">
          <div className={`transition-all duration-700 ${
            ...
            <div className="space-y-4 max-w-xl mx-auto text-center md:text-justify">
