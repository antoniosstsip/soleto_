  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative overflow-hidden w-full" style={{ 
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/20 to-black/60" style={{
          position: 'absolute',
          top: 0,
          left: 0,
          right: 0,
        ...
        <div className="relative z-10 flex flex-col items-center justify-end h-full text-center px-5 pb-20" style={{
          paddingTop: 'env(safe-area-inset-top, 20px)'
        }}>
          {/* Pure Summer Tagline */}
          <div className={`mb-8 w-full max-w-xs transition-all duration-700 delay-200 ${
          ...
          <div className={`mb-12 w-full max-w-[220px] transition-all duration-700 delay-250 ${
            isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}>
            <div 
              style={{ 
          ...
          <div className={`flex flex-col gap-6 w-full max-w-sm transition-all duration-700 delay-300 ${
            isVisible.hero ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}>
            <Button 
