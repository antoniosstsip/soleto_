          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-6">
            <div className="text-center">
              ...
              <div className="flex gap-1 justify-center mb-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    key={star}
                    className="w-5 h-5 fill-[#D8AB42] text-[#D8AB42]"
                  />
                ))}
              </div>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-wrap gap-2 justify-center mb-6">
                <span className="px-3 py-1 bg-[#D8AB42]/10 text-gray-700 rounded-full active:bg-[#D8AB42] active:text-white transition-all duration-300 cursor-pointer touch-manipulation active:scale-95">
              ...
              <a 
                ...
                className="inline-flex items-center gap-2 px-5 md:px-6 py-3 bg-white border-2 border-gray-200 rounded-lg shadow-sm active:shadow-xl active:border-[#D8AB42]/30 transition-all duration-300 cursor-pointer touch-manipulation active:scale-95"
              >
      ...
      <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
        <div className="grid md:grid-cols-2 gap-4 md:gap-6">
          {reviews.map((review, index) => (
            <Card key={index} className="group p-4 md:p-6 bg-white border-gray-200 active:shadow-xl active:shadow-[#D8AB42]/10 transition-all duration-300 active:border-[#D8AB42]/30">
              <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                <Avatar className="w-10 h-10 md:w-12 md:h-12 transition-transform duration-300 flex-shrink-0">
                  <AvatarFallback className="bg-[#D8AB42] text-white">
                    {review.initials}
                  </AvatarFallback>
                </Avatar>
                <div className="flex-1 min-w-0">
                  <h4 className="text-gray-900 font-heading group-active:text-[#D8AB42] transition-colors duration-300">{review.name}</h4>
