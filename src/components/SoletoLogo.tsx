import SoletoText from "../imports/G192-166-643";
...
export function SoletoLogo({ className = "", showTagline = true, showDots = true, style, taglineColor = "#FFFFFF" }: SoletoLogoProps) {
  return (
      ...
      <div className="flex flex-col items-center gap-2">
        ...
        {showTagline && (
          <div className="flex items-start justify-between w-full">
            ...
            <div style={{ width: '48%', aspectRatio: '463/158', '--fill-0': taglineColor, transform: 'scaleY(-1)' } as React.CSSProperties}>
              <TaglineText />
            </div>
          </div>
        )}
